                ...
                <div class="container">
                    <div class="row">
                        ...
                        <header class="col-md-12 jumbotron bg-danger text-light text-center">
                            ...
                            <section id="open-hours" class="col-12 text-center">
                                <section>
                                    <a id="help" href="https://www.facebook.com/Pomagamy-bo-kochamy-392452218157056/" target="_blank" class="navbar-brand text-danger">
                                    <i class="glyph-icon flaticon-food-and-restaurant"></i> 
                                    <strong>PizzoMania</strong>
                                    </a>
                                    <button class="navbar-toggler" type="button" data-toggle="collapse" data-target="#collapsibleNavbar">
                                    ...
                                    <table>
                                        <tr>
                                            <td>Poniedziałek</td><td>Nieczynne</td>
                                        </tr>
                                        <tr>
                                            <td>Wtorek</td><td>14.00 - 21.00</td>
                                        </tr>
                                        <tr>
                                            <td>Środa</td><td>14.00 - 21.00</td>
                                        </tr>
                                        <tr>
                                            <td>Czwartek</td><td>14.00 - 21.00</td>
                                        </tr>
                                        <tr>
                                            <td>Piątek</td><td>14.00 - 21.00</td>
                                        </tr>
                                        <tr>
                                            <td>Sobota</td><td>14.00 - 21.00</td>
                                        </tr>
                                        <tr>
                                            <td>Niedziela</td><td>14.00 - 21.00</td>
                                        </tr>
                                    </table>
                                </div>
