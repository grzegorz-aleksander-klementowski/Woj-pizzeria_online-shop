<!DOCTYPE html>
    <html lang="pl">
        <head>
            ...
            <link rel="stylesheet" type="text/css" href="css/icons/font/fontello.css">
            <link rel="stylesheet" type="text/css" href="css/icons/font/fontello-phone-mail-localization/css/fontello.css">
            ...
            icons: https://www.flaticon.com/, fontello.com
            -->
        </head>
            ...
            <main>
                <div class="container">
                    <div class="row">
                        ...
                        <div class="jumbotron bg-danger text-light text-center col-12"><h3>Skontaktuj się z nami!</h1></div>
                        
                        <div class="col">

                            <a href="mailto:kontakt@pizzomania.com" target="_blank">
                                <button class="col-12 btn btn-danger contact-baners jumbotron bg-danger text-light text-center">
                                    <i class="demo-icon icon-mail-alt">&#xf0e0;</i>
                                    <p>kontakt@pizzomania.com</p>
                                </button>
                            </a>
                            ...
                            <button class="btn btn-danger jumbotron text-light bg-danger text-center contact-baners col"><i class="demo-icon icon-phone">&#xe800;</i><p>+48 510 865 444</p></button>
                        </div>
                        
                        <div class="col">
                                <div id="map">
                                    <iframe src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d2513.7127597651442!2d15.92211491510908!3d50.947524959305056!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x470f1d019d44c307%3A0x6238a0c7842f37d5!2sPIZZOMANIA!5e0!3m2!1sen!2spl!4v1582734877347!5m2!1sen!2spl" width="100%" height="400" frameborder="0" style="border:0;" allowfullscreen=""></iframe>
                                </div>
                                <a href="https://goo.gl/maps/hrCNnC4qxfwpPZ7H7" target="_blank">
                                    <button class="btn btn-danger contact-baners jumbotron bg-danger text-light text-center">
                                        <i class="demo-icon icon-location">&#xf031;</i> <span class="i-name">
                                        <p>ul. Bolesława Chrobrego 75a,<br> 59-550 Wojcieszów</p>
                                    </button>
                                </a>
                        </div>
